...
# Load a second sample picture and learn how to recognize it.
roqaia_image = face_recognition.load_image_file("images/Roqaia.jpg")
roqaia_face_encoding = face_recognition.face_encodings(roqaia_image)[0]
